  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background p-4">
      <div className="w-full max-w-md">
        ...
        <div className="rounded-2xl border border-border bg-surface p-8">
          ...
          <div className="space-y-3">
            ...
            >
              <button
                type="submit"
                className="flex w-full items-center justify-center gap-3 rounded-xl bg-[#24292e] px-4 py-3 text-sm font-semibold text-white transition-all hover:bg-[#2f363d] focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-background"
              >
            ...
            >
              <button
                type="submit"
                className="flex w-full items-center justify-center gap-3 rounded-xl border border-border bg-surface-elevated px-4 py-3 text-sm font-semibold text-foreground transition-all hover:bg-surface hover:border-primary/50 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-background"
              >
        ...
        {/* Footer */}
        <p className="mt-6 text-center text-xs text-muted-foreground">
          By signing in, you agree to keep your thoughts safe and sound
        </p>
      </div>
    </div>
  );
